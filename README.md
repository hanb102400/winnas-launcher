...
> | 版本 | 下载 |
> |------|------|
> | 绿色便携版（推荐，解压即用） | [WinNas-Launcher-portable.zip](https://github.com/hanb102400/winnas-launcher/releases/download/v0.1.2/WinNas-Launcher-portable.zip) |
> | 常规安装版 | [WinNas.Launcher_0.1.2_x64-setup.exe](https://github.com/hanb102400/winnas-launcher/releases/download/v0.1.2/WinNas.Launcher_0.1.2_x64-setup.exe) |
>
...
1. 下载 `WinNas.Launcher_0.1.2_x64-setup.exe`
2. 双击安装
